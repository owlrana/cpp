...
# Define a functino to find the truth in a secret message
...
def lassoWord( word, shiftAmount):
    ...
    # This is for loop iterates through each letter in the word parameter
    for letter in word:
        # The lassoLetter() function is evoked with each letter and the shift amount
        # The result (decoded letter) is stored in a variable called decoded letter
